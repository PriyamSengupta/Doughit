...
class Users extends CI_Controller {
	...
	public function index()
	{
		...
		$details=$this->main_model->get_full_details_table("business_user");   
        $viewdata['details']=$details;
        // print_r($details); die();
		$this->layout_admin->view('/admin/user/index',$viewdata);
    }
	...
	// 	if($id== '')
	// 	{		   	
    //         $viewdata['mainheader']='Add User';
	// 		$details=$this->chef_model->get_chef_details(0);   
    //         $viewdata['details']=$details;
	// 		$this->layout_admin->view('/admin/user/addedit',$viewdata);
	// 	}
	// 	else
	// 	{
	// 	    $viewdata['mainheader']='Edit User';    
    ...
    public function change_status()
	{
	    ...
	    $details=$this->user_model->change_status($id, "business_user");
	    
	    $viewdata['details']=$details;
		if(!empty($details))
		{
			$viewdata=$this->load->view('/admin/user/ajaxdata',$viewdata);
			return $viewdata;
