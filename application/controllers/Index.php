...
class Index extends CI_Controller {
	...
	{
		$viewdata['mainheader']='Home';

		$getdata = array();
		$getdata['table_name'] = 'chef';
		$getdata['field_name'] = '*';
		...
		$getdata['start'] = 0;
		$getdata['join'] = array();
		$viewdata['chefs'] = $this->main_model->get_full_details($getdata);
		// $viewdata['service_info']=$this->service_model->service_info(0);  //0 = service
		// $viewdata['essential_service_info']=$this->service_model->service_info(1); //1 = essential service
		$this->layout_front->view('/front/index/index',$viewdata);
	}
	...
	public function get_products()
	{
		...
		// echo count($details);
		$viewdata=$this->load->view('/front/index/ajaxproducts',$viewdata);
		return $viewdata;
	}
