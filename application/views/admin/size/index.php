...
<div class="row gutters">
  ...
  ?>
    <div class="table-container">
      <div class="t-header">
          <?=$mainheader?>
          <a class="btn btn-secondary" href='<?=$this->config->item("base_url")."admin/size/addedit"?>' style="float:right"  role="button">Add New</a>
      </div>
...
<script>
  ...
  <script>
    function change_status(id)
    {
        $.ajax({
              type: 'POST',
              url: '<?= base_url()?>admin/size/change_status',
              data: {'size_id':id},
              dataType: "html",
