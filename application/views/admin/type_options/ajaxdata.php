<table id="basicExample" class="table custom-table">
          ...
          <tbody>
            ...
            <tr>
              <td><?=$sl?></td>
              <td><?=$detail->name?></td>
              <td><?=get_type($detail->type_id)?></td>
              <td><?php 
                if($detail->image=='no_image.png' || $detail->image== '')
                  {?>
                    <img src="<?=$this->config->item('base_url')?>upload/type_option/normal/no_image.png" style="height: 80px; width: 80px">
                <?php } else 
                { ?><img src="<?=$this->config->item('base_url').'upload/type_option/normal/'.$detail->image?>" style="height: 80px; width: 80px">
                <?php } ?>
              </td>
              <td>
