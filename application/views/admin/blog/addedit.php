  ...
  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form method="POST" action="<?=$this->config->item('base_url').'admin/blog/addedit_blog'?>" enctype="multipart/form-data">
          <input type="hidden" name="id" id="blog_id" value="<?=$details->id?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="title" id="title" placeholder="First Name" class="form-control" value="<?=$details->title?>">
            </div>
          </div>
          ...
          <div class="form-group row preview_img" <?php if($details->id=='') { ?> style="display: none;" <?php } ?>>
            ...
            <div class="col-sm-10">
              <?php if($details->id=='') { ?>
                <img id="img_preview"/>
              <?php } else { ?>
                <img id="img_preview" src="<?=base_url()?>upload/blog/normal/<?=$details->image?>" style="width:300px ; height:200px;"/>
              <?php } ?>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea name="content" id="content" placeholder="Content" rows="8" class="form-control"><?=$details->content?></textarea>
            </div>
          </div>
