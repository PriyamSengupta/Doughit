...
<div class="row gutters">
  ...
  ?>
    <div class="table-container">
      <div class="t-header">
          <?=$mainheader?>
          <a class="btn btn-secondary" href='<?=$this->config->item("base_url")."admin/blog/addedit"?>' style="float:right"  role="button">Add New</a>
      </div>
        ...
        <table id="basicExample" class="table custom-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?=date("F j, Y", strtotime($detail->time))?></td>
              <td>
  ...
  <script>
    function change_status(id)
    {
      console.log(id);
        $.ajax({
              type: 'POST',
              url: '<?= base_url()?>admin/blog/change_status',
              data: {'blog_id':id},
              dataType: "html",
