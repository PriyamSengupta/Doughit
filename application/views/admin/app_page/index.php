...
<div class="row gutters">
  ...
  ?>
    <div class="table-container">
      <div class="t-header">
          <?=$mainheader?>
          <a class="btn btn-secondary" href='<?=$this->config->item("base_url")."admin/app_page/addedit"?>' style="float:right"  role="button">Add New</a>
      </div>
      ...
      <div class="table-responsive">
        <table id="basicExample" class="table custom-table">
          ...
          <tbody>
            ...
            { 
              $editurl=$this->config->item('base_url').'admin/app_page/addedit/'.$detail->id;
              ?>
...
<script>
  ...
  <script>
    function change_status(id)
    {
        $.ajax({
              type: 'POST',
              url: '<?= base_url()?>admin/app_page/change_status',
              data: {'page_id':id},
              dataType: "html",
