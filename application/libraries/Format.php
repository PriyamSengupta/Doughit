<?php
	...
	class Format{
		 ...
		 *
		 * @return array otherwise, empty array
		 */
		...
		/**
		 * @param $data String Encoded json
		 *
		...
		/**
		 * @param $data string Data to unserialized
		 *
		...
		/**
		 * @param $data string Data to trim leading and trailing whitespace
		 *
